...
def task_loop():
    ...
    SYSTEM_PROMPT = (
        ...
        "- Never take two screenshots in a row. Never take a screenshot to verify a page loaded or an action worked — trust the tool result automatically.\n"
        ...
        "- On Sephora: if a product has the 'Clean at Sephora' badge, that is enough — do NOT scroll through ingredients or read reviews. Add to Basket immediately.\n"
        ...
        "- After adding an item to cart, a popup appears. Press Escape to dismiss it, then click the Sephora search bar in the header.\n"
